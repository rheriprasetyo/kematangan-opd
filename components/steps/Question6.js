...
function Question6({ data, setData }) {
  ...
  url === null
    ? (data.evidence6 = "-")
    : (data.evidence6 = `https://pusjaotypxzrwwkvbqwk.supabase.co/storage/v1/object/public/upload-kematangan-opd/${url}`);
  data.url = url;
          ...
          <tbody>
            <tr className="border-b-2">
              ...
              <td className="px-6 py-4">
                Analisis kebijakan dan pemecahan masalah dilakukan secara
            ...
            <tr className="border-b-2">
              ...
              <td className="px-6 py-4">
                Analisis kebijakan yang berdampak ke publik dilakukan oleh tim
            ...
            <tr className="border-b-2">
              ...
              <td className="px-6 py-4">
                Analisis kebijakan dan pemecahan masalah yang berdampak ke
            ...
            <tr className="border-b-2">
              ...
              <td className="px-6 py-4">
                ...
                publik melibatkan tim ahli dengan melakukan konsultasi publik
                dan analisis umpan balik yang terukur dan terdokumentasi.
              </td>
            </tr>
          </tbody>
        </table>
          ...
          <form id="form" noValidate>
            <div className="relative z-0 w-full mb-5">
              <select
                ...
                onChange={(event) =>
                  setData({ ...data, question6: event.target.value })
                }
