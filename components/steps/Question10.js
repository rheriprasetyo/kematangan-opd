...
function Question10({ data, setData }) {
  ...
  url === null
    ? (data.evidence10 = "-")
    : (data.evidence10 = `https://pusjaotypxzrwwkvbqwk.supabase.co/storage/v1/object/public/upload-kematangan-opd/${url}`);
  data.url = url;
          ...
          <form id="form" noValidate>
            <div className="relative z-0 w-full mb-5">
              <select
                ...
                onChange={(event) =>
                  setData({ ...data, question10: event.target.value })
                }
